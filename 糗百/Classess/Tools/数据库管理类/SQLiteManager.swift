...
class SQLiteManager {
    ...
    private func createTable() {
        ...
        let sql =  "CREATE TABLE IF NOT EXISTS t_student ('id' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT ,content text );"
...
//     5> 测试！
//     */
//     func saveCacheData(array: [HomeData]) {
//        
//        
//        
//        // 1. 准备 SQL
...
//         3. userId -> 登录的用户
//         */
//        let sql = "INSERT OR REPLACE INTO T_Status (id, content) VALUES (?,  ?);"
//        
